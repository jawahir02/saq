class SAQHeader extends HTMLElement {
    ...
    connectedCallback() {
        this.innerHTML = `
            <style>
                .main-header {
                    background-color: var(--off-white, #F9F8F6);
            ...
            <header class="main-header">
                <div class="header-container">
                    <a href="index.html" class="logo-container">
                        ...
                        <div class="logo-text">SAQ<br>Building Materials</div>
                    </a>
                    <nav class="nav-links">
                        ...
                        <a href="mailto:sales@saqtrading.com?subject=Request a Quote" class="nav-cta">Request a Quote</a>
                    </nav>
                ...
                <nav class="mobile-nav">
                    ...
                    <a href="brands.html">Brands</a>
                    <a href="careers.html">Careers</a>
                    <a href="mailto:sales@saqtrading.com?subject=Request a Quote" style="color: var(--navy-blue); font-weight: bold;">Request a Quote</a>
                </nav>
            </header>
        `;
