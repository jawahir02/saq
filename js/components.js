        ...
        this.innerHTML = `
            <style>
                ...
                .header-container {
                    ...
                    align-items: flex-end; /* Align bottom to keep links aligned with logo bottom */
                    padding: 0 5%;
                }
                .logo-container {
                    display: flex;
                ...
                .logo-container img {
                    height: 60px; /* Base height for logo */
                    margin-bottom: 4px;
                }
                .logo-descriptor {
                ...
                .nav-links {
                    ...
                    gap: 2.5rem;
                    align-items: center;
                    padding-bottom: 5px; /* Visual alignment with logo */
                }
                ...
                @media (max-width: 768px) {
                    ...
                    .mobile-menu-btn { display: block; margin-bottom: 10px; }
                    .header-container { padding: 0.8rem 5%; align-items: center; }
                    .logo-container img { height: 45px; }
                    .logo-descriptor { font-size: 0.45rem; }
                }
            </style>
            <header class="main-header">
                <div class="header-container">
                    <a href="index.html" class="logo-container">
                        <img src="herologo.png" alt="SAQ" onerror="this.src='1.png'">
                        <div class="logo-descriptor">BUILDING MATERIALS SUPPLIER IN DUBAI</div>
                    </a>
                    <nav class="nav-links">
                        <a href="index.html" class="nav-link-item">Home</a>
                        <a href="about.html" class="nav-link-item">About</a>
                        <a href="products.html" class="nav-link-item">Products</a>
