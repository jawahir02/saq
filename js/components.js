        ...
        this.innerHTML = `
            ...
            <header class="main-header" id="main-header">
                ...
                <nav class="mobile-nav">
                    ...
                    <a href="mailto:info@saq-materials.com" class="nav-cta-mobile" style="background-color: transparent; border: 1px solid var(--charcoal); color: var(--charcoal) !important; margin-top: 0.5rem;">
